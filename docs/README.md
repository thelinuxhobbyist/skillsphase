...
1. [01 — Product Requirements](./01-product-requirements.md)
2. [02 — User Roles](./02-user-roles.md)
3. [03 — User Flows](./03-user-flows.md)
4. [04 — Pages](./04-pages.md)
5. [05 — Database Schema](./05-database-schema.md)
6. [06 — API Specification](./06-api-specification.md)
7. [07 — Authentication](./07-authentication.md)
8. [08 — Employer Verification](./08-employer-verification.md)
9. [09 — Admin Panel](./09-admin-panel.md)
10. [10 — Security](./10-security.md)
...
Original `.docx` drafts are preserved under [`../archive/original-docx/`](../archive/original-docx/). The markdown files in this folder supersede them.
